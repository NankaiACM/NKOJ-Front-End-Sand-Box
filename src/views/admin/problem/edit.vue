...
@Options({
  emits: ['problemDataSubmit'],
  computed: {
    descriptionRender() { return markdownIt.render(this.problemData.description); },
    inputRender() { return markdownIt.render(this.problemData.input); },
    outputRender() { return markdownIt.render(this.problemData.output); },
    sampleInputRender() { return markdownIt.render(this.problemData.sample_input); },
    sampleOutputRender() { return markdownIt.render(this.problemData.sample_output); },
    hintRender() { return markdownIt.render(this.problemData.hint); },
  },
  watch: {
    preProblemData() {
